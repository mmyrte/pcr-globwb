...
class Configuration(object):
    ...
    def repair_ini_key_names(self):
        ...
        if (
            "irrigationEfficiency" not in list(self.landSurfaceOptions.keys())
        ...
        if "allocationSegmentsForGroundSurfaceWater" not in list(
            self.landSurfaceOptions.keys()
        ):
        ...
        if "avgTotalGroundwaterAbstractionIni" not in list(
            self.groundwaterOptions.keys()
        ):
        ...
        if "avgTotalGroundwaterAllocationLongIni" not in list(
            self.groundwaterOptions.keys()
        ):
        ...
        if "avgTotalGroundwaterAllocationShortIni" not in list(
            self.groundwaterOptions.keys()
        ):
        ...
        if "avgNonFossilGroundwaterAllocationLongIni" not in list(
            self.groundwaterOptions.keys()
        ):
        ...
        if "avgNonFossilGroundwaterAllocationShortIni" not in list(
            self.groundwaterOptions.keys()
        ):
        ...
        if "limitFossilGroundWaterAbstraction" not in list(
            self.groundwaterOptions.keys()
        ):
        ...
        if "treshold_to_maximize_irrigation_surface_water" not in list(
            self.landSurfaceOptions.keys()
        ):
        ...
        if "treshold_to_minimize_fossil_groundwater_irrigation" not in list(
            self.landSurfaceOptions.keys()
        ):
        ...
        if (self.landSurfaceOptions["includeDomesticWaterDemand"] == "False") and (
            "domesticWaterDemandFile" not in list(self.landSurfaceOptions.keys())
        ):
        ...
        if (self.landSurfaceOptions["includeIndustryWaterDemand"] == "False") and (
            "industryWaterDemandFile" not in list(self.landSurfaceOptions.keys())
        ):
        ...
        if (self.landSurfaceOptions["includeLivestockWaterDemand"] == "False") and (
            "livestockWaterDemandFile" not in list(self.landSurfaceOptions.keys())
        ):
        ...
        if "prioritizeLocalSourceToMeetWaterDemand" not in list(
            self.landSurfaceOptions.keys()
        ):
