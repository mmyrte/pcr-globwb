...
def modify_ini_file(original_ini_file, system_argument):
    ...
    if "-misd" in system_argument:
        ...
        file_ini_content = file_ini_content.replace(
            "INITIAL_CONDITION_FOLDER", main_initial_state_folder
        )
        msg = (
    ...
    if "-pff" in system_argument:
        ...
        file_ini_content = file_ini_content.replace(
            "PRE_FILE", precipitation_forcing_file
        )
        msg = (
    ...
    if "-tff" in system_argument:
        ...
        file_ini_content = file_ini_content.replace(
            "TMP_FILE", temperature_forcing_file
        )
        msg = (
    ...
    if "-radff" in system_argument:
        ...
        msg = (
            "The radiation forcing file 'RAD_FILE' is set based on the system argument (-radff): "
            + rad_forcing_file
        )
        print(msg)
    ...
    if "-tmp_annavg_ff" in system_argument:
        ...
        file_ini_content = file_ini_content.replace(
            "TMP_ANNUAL_AVG_FILE", tmp_annavg_ff
        )
        msg = (
            "The file 'TMP_ANNUAL_AVG_FILE' is set based on the system argument (-tmp_annavg_ff): "
            + TMP_ANNUAL_AVG_FILE
        )
        print(msg)
    ...
    if "-irr_fl" in system_argument:
        ...
        msg = (
            "The 'IRRIGATION_AREA_FILE' is set based on the system argument (-irr_fl): "
            + irr_fl
        )
        print(msg)
    ...
    if "-dom_fl" in system_argument:
        ...
        msg = (
            "The 'DOM_WATER_DEMAND_FILE' is set based on the system argument (-dom_fl): "
            + dom_fl
        )
        print(msg)
    ...
    if "-ind_fl" in system_argument:
        ...
        msg = (
            "The 'IND_WATER_DEMAND_FILE' is set based on the system argument (-ind_fl): "
            + ind_fl
        )
        print(msg)
